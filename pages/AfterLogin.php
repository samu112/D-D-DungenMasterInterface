...
?>
 ...
 <form class="form-inline">
    <button class="btn btn-outline-success" type="button" style="font-size: 2rem">Global settings</button>
    <button class="btn btn-outline-success disabled" type="button" style="font-size: 2rem">Session code: +++++++++</button>
    <button class="btn btn-outline-success" type="button" style="font-size: 2rem"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
