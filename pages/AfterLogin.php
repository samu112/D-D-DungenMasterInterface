...
?>
 ...
 <div class="menuX" style="text-align: center;">
  <div class="itemX"><button type="button" class="btn btn-primary btn-lg">Players</button></div>
  <div class="itemX"><button type="button" class="btn btn-primary btn-lg">Items</button></div>
  <div class="itemX"><button type="button" class="btn btn-primary btn-lg">Monsters</button></div>
